        ...
        <table class="manage-table">
          <thead>
            <tr>
              ...
              <th style="width: 180px;">Naam Onderdeel</th>
              <th style="width: 130px;">Categorie</th>
              <th style="width: 80px;">Max/Slot</th>
              <th style="width: 80px;">Max/Wk</th>
              <th style="width: 180px;">🔗 Vereiste Voorwaarde</th>
              <th>Beschrijving</th>
          ...
          <tbody>
            ...
            <tr v-if="activities.length === 0">
              <td colspan="8" class="empty-state">Geen onderdelen aangemaakt.</td>
            </tr>
          </tbody>
        </table>
      </div>
